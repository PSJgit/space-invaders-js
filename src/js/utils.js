...
export function bounceOff(particle, otherParticle) {

	// params 
	particle.mass = 1
	otherParticle.mass = 1
...
export function detectCollision(particle, otherParticle) {
	if (particle.x < otherParticle.x + otherParticle.width &&	// 
	   	particle.x + particle.width > otherParticle.x &&
	   	particle.y < otherParticle.y + otherParticle.height &&
	   	particle.y + particle.height > otherParticle.y) {
	    // collision detected!
		return true
	}
}
